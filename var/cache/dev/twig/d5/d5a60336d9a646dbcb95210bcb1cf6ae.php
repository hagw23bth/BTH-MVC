...
class __TwigTemplate_eb7d81a2a00286859b3c477e19b991fb extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["book"]) {
            // line 19
            yield "            <a href=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("library_view_one", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["book"], "id", [], "any", false, false, false, 19)]), "html", null, true);
            yield "\" class=\"book-link\">
                <div class=\"book\">
                    <img src=\"";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("img/" . CoreExtension::getAttribute($this->env, $this->source, $context["book"], "image", [], "any", false, false, false, 21))), "html", null, true);
            yield "\" alt=\"";
...
";
    ...
    {
        return array (  147 => 28,  137 => 24,  133 => 23,  129 => 22,  123 => 21,  117 => 19,  113 => 18,  103 => 11,  99 => 10,  95 => 9,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
<div class=\"inner-container grid-container\">
    ...
    <div class=\"content\">
        ...
        <div class=\"books-container\">
        {% for book in books %}
            <a href=\"{{ path('library_view_one', {'id': book.id}) }}\" class=\"book-link\">
                <div class=\"book\">
...
{% endblock %}
", "library/view.html.twig", "/Users/hannagawlitza/dbwebb-kurser/mvc/me/report/templates/library/view.html.twig");
    }
}
